    ...
    <div class="row">
        ...
        ?>
                ...
                <div class="col-lg-4 col-md-6 my-3">
                    <div class="card border-0 shadow pop" style="max-width: 350px; margin: auto; box-shadow: 5px 5px 8px #999;">
...
<!-- Thêm đoạn mã này vào trước thẻ đóng </body> -->
...
<script>
    ...
    function showToast() {
        ...
        const showToastEl = new bootstrap.Toast(toastEl);
        return showToastEl.show();
    }
